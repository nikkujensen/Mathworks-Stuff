...
% Typically, a reshape like "reshape(y,N,[])" is followed after. Receives
% signals that are column vectors. If multiple signals are included then it
% will read them all as column vectors.
